...
const GitHub: FC<Props> = ({}) => {
  return (
    <a
      className="GitHub"
      href="https://github.com/panprogramadorgh?tab=repositories"
    >
      <div className="GitHub__icon-container">
        <svg
          stroke="currentColor"
          fill="currentColor"
          strokeWidth="0"
      ...
      <div className="GitHub__message-container">
        <span>Apoyame en GitHub</span>
        <span>@panprogramadorgh</span>
      </div>
    </a>
  );
};
